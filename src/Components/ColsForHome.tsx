    ...
    <div className="sm:grid sm:grid-cols-2 md:grid-cols-4 px-8 md:px-[12vw] gap-4 my-12">
      <div className="flex flex-row items-center gap-4 my-3">
        <img
          ...
          height="300"
          alt="Delivery"
          src="src/assets/images/ecommerce/fast-delivery.png"
        />
      ...
      <div className="flex flex-row items-center gap-4 mt-3 ">
        <img
          ...
          height="300"
          alt="Delivery"
          src="src/assets/images/ecommerce/returns.png"
        />
        <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-row items-center gap-4 mt-3">
        <img
          ...
          height="300"
          alt="Delivery"
          src="src/assets/images/ecommerce/guarantee-certificate.png"
        />
        <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-row items-center gap-4 mt-3">
        <img
          ...
          height="300"
          alt="Delivery"
          src="src/assets/images/ecommerce/24-hours-support.png"
        />
        <div className="flex flex-col gap-2">
